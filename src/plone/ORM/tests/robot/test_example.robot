...
#
#  $ bin/test -s plone.ORM -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src plone.ORM.testing.PLONE_ORM_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/plone/ORM/tests/robot/test_example.robot
#
